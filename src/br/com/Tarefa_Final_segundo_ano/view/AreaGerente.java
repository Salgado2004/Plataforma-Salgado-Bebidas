...
public class AreaGerente extends JFrame {
	...
	public AreaGerente() {
		...
		tabbedPane.addTab("Livro Caixa", null, panel_3, null);
		tabbedPane.setForegroundAt(1, new Color(128, 0, 0));
		tabbedPane.setBackgroundAt(1, Color.YELLOW);
		panel_3.setLayout(null);

		JScrollPane painelScroll_1 = new JScrollPane(livroCaixa);
		painelScroll_1.setSize(389, 140);
		painelScroll_1.setLocation(10, 35);
		panel_3.add(painelScroll_1);
		livroCaixa.setVisibleRowCount(10);
		livroCaixa.setFont(new Font("Bahnschrift", Font.PLAIN, 10));
		livroCaixa.setBounds(0, 11, 430, 195);

		JButton btnVendas = new JButton("Vendas");
		btnVendas.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				model3.removeAllElements();
				livroCaixa.setModel(model3);
				ArrayList<Venda> listaVendas = new ArrayList<Venda>();
				try {
					conn = conexao.conectar();
					listaVendas.addAll(bd.vendas(conn, "venda"));
					for (Venda venda : listaVendas) {
						livroCaixa.setModel(model3);
						model3.addElement(venda.toString());
					}
					conexao.desconectar(conn);
				} catch (ClassNotFoundException e1) {
					e1.printStackTrace();
		...
		btnVendas.setFont(new Font("Bahnschrift", Font.PLAIN, 12));
		btnVendas.setForeground(new Color(128, 0, 0));
		btnVendas.setBackground(new Color(255, 248, 220));
		btnVendas.setBounds(212, 11, 89, 23);
		panel_3.add(btnVendas);
		...
		btnCompras.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					conn = conexao.conectar();
					listaCompras.addAll(bd.compras(conn, "compra"));
					for (Compra compra : listaCompras) {
						livroCaixa.setModel(model3);
						model3.addElement(compra.toString());
					}
					conexao.desconectar(conn);
				} catch (ClassNotFoundException e1) {
					e1.printStackTrace();
		...
		btnCompras.setForeground(new Color(128, 0, 0));
		btnCompras.setFont(new Font("Bahnschrift", Font.PLAIN, 12));
		btnCompras.setBackground(new Color(255, 248, 220));
		btnCompras.setBounds(310, 12, 89, 23);
		...
		tabbedPane.setBackgroundAt(3, new Color(128, 0, 0));
		...
		JLabel lblNewLabel = new JLabel("Acesso de Gerente");
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null,
						"O acesso de gerente permite ao usuário \nver o estoque, cadastrar novas vendas e compras e acessar o livro caixa");
			}
		});
		...
		btnNewButton_2.setBounds(139, 11, 64, 25);
